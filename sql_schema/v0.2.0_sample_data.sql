...
INSERT INTO `canban`.`boards` (`ID`, `NAME`, `PARENT`, `CREATION_DATE`, `WIP`)
VALUES
	('1', 'Personal Board', NULL, CURRENT_TIMESTAMP, -1),
	('2', 'Personal Board', NULL, '2014-05-14 05:22:38', -1),
	('3', 'Personal Board', NULL, '2013-11-21 17:01:10', -1),
	('4', 'Build Dog House', NULL, '2014-05-14 05:22:38', 1),
	('5', 'Take a woodshop class', '4', '2014-05-14 05:22:38', 2);
...
ALTER TABLE `boardhasticket` AUTO_INCREMENT = 25;
ALTER TABLE `userhasboard` AUTO_INCREMENT = 6;
ALTER TABLE `tickets` AUTO_INCREMENT = 25;
