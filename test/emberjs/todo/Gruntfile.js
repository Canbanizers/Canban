module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		concat          : {
			vendor : {
				src : ['app/library/jquery-1.10.2.js', 'app/library/handlebars-1.1.2.js', 'app/library/ember-1.2.0.js',
					   ...
					   'app/library/ember-auth.min.js', 'app/library/ember-auth-request-jquery.min.js',
					   'app/library/ember-auth-response-json.min.js', 'app/library/ember-auth-strategy-token.min.js',
					   'app/library/ember-auth-session-local-storage.min.js'],
				dest: 'debug/lib.js'
			},
			app    : {
		...
		less            : {
			css: {
				files: {
					'debug/app.css': 'app/css/base.less'
				}
			}
		},
		ember_handlebars: {
		...
		watch           : {
			scripts: {
				files  : ['app/library/*.js', 'app/*.js', 'app/controllers/*.js', 'app/views/*.js', 'app/routes/*.js',
						  'app/models/*.js', 'app/css/*.scss', 'app/templates/**/*.hbs', 'app/tests/*.js'],
	...
	grunt.registerTask('default', ['ember_handlebars', 'concat', 'less', 'clean', 'copy', 'connect', 'watch']);
