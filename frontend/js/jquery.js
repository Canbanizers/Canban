...
function showBord(name) {
	jq(".main_content").html("<div class=\"row\">" + "<div class=\"col-md-1\"></div>" + "<h1 class=\"col-md-10\">" +
							 name + "</h1>" + "<div class=\"col-md-1\"></div>" + "</div>" + "<div class=\"row\">" +
							 "<div class=\"col-md-1\"></div>" + " <div class=\"col-md-10\">" +
							 "<section class=\"container board_border\">" +
							 "<section class=\"row board_background\"></section>" + "</section>" + "</div>" +
