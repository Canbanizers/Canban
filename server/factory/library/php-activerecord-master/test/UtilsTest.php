...
class UtilsTest extends SnakeCase_PHPUnit_Framework_TestCase {
	...
	public function test_collect_with_array_of_objects_using_closure() {
		$this->assert_equals(array("0a", "1a"), ActiveRecord\collect($this->object_array, function ($obj) {
			return $obj->a;
		}));
	}
	...
	public function test_collect_with_array_hash_using_closure() {
		$this->assert_equals(array("0a", "1a"), ActiveRecord\collect($this->array_hash, function ($item) {
			return $item["a"];
		}));
	}
	...
	public function test_array_flatten() {
		...
		$this->assert_equals(array(1, 2, 3, 4, 5, 6),
			ActiveRecord\array_flatten(array(1, array(2, 3), 4, array(5, 6))));
	}
