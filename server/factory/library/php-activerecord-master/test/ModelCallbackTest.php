...
class ModelCallbackTest extends DatabaseTest {
	...
	public function test_fire_validation_callbacks_on_insert() {
		$this->assert_fires(array('before_validation', 'after_validation', 'before_validation_on_create',
	...
	public function test_fire_validation_callbacks_on_update() {
		$this->assert_fires(array('before_validation', 'after_validation', 'before_validation_on_update',
