...
class ValidatesNumericalityOfTest extends DatabaseTest {
	...
	static $JUNK = array("not a number", "42 not a number", "00-1", "--3", "+-3", "+3-1", "-+019.0", "12.12.13.12",
		"123\nnot a number");
	...
	public function test_greater_than_less_than_and_even() {
		BookNumericality::$validates_numericality_of[0] =
			array('numeric_test', 'greater_than' => 1, 'less_than' => 4, 'even' => true);
